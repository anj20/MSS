...
def upgrade():
    ...
    with op.batch_alter_table('changes', schema=None) as batch_op:
        batch_op.alter_column('version_name', existing_type=sa.String(255), nullable=True)
        batch_op.alter_column('comment', existing_type=sa.String(255), nullable=True)
...
def downgrade():
    ...
    with op.batch_alter_table('changes', schema=None) as batch_op:
        batch_op.alter_column('version_name', existing_type=sa.String(255), nullable=False)
        batch_op.alter_column('comment', existing_type=sa.String(255), nullable=False)
    # ### end Alembic commands ###
